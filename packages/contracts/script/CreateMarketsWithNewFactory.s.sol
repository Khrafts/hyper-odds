...
contract CreateMarketsWithNewFactory is Script {
    function run() external {
        ...
        btcParams.description =
            "A prediction market on whether Bitcoin will trade above $70,000 USD on major exchanges by August 20, 2025 at 12:00 UTC";
        ...
        btcParams.predicate.threshold = 70_000 * 1e8;
        ...
        btcParams.econ.maxTotalPool = 100_000 * 1e6;
        ...
        hlParams.description =
            "Prediction on HyperLiquid protocol achieving over $1 billion in Total Value Locked across all vaults and LP positions";
        ...
        hlParams.predicate.threshold = 1_000_000_000 * 1e6;
        ...
        hlParams.econ.maxTotalPool = 50_000 * 1e6;
