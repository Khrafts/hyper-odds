...
contract RouterTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy factory
        factory = new MarketFactory(address(usdc), address(stHypeToken), treasury, address(oracle));
        ...
        MarketTypes.MarketParams memory params1 =
            createMarketParams("Will BTC hit $100k?", "Bitcoin price prediction", block.timestamp + 1 hours);
        market1 = factory.createParimutuelMarket(params1);

        MarketTypes.MarketParams memory params2 =
            createMarketParams("Will ETH hit $5k?", "Ethereum price prediction", block.timestamp + 2 hours);
    ...
    function createMarketParams(
        ...
        internal
        view
        returns (MarketTypes.MarketParams memory)
    {
        return MarketTypes.MarketParams({
            ...
            predicate: MarketTypes.PredicateParams({ op: MarketTypes.PredicateOp.GT, threshold: 100_000 * 1e8 }),
    ...
    function testRescueToken() public {
        ...
        assertEq(usdc.balanceOf(alice), 10_100e18);
    }
    ...
    function testBatchClaims() public {
        ...
        vm.warp(18_001); // market2 resolve time
