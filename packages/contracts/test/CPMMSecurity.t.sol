...
contract CPMMSecurityTest is Test {
    ...
    function setUp() public {
        ...
        stakeToken.mint(creator, 10_000e18);
        stakeToken.mint(attacker, 50_000e18);
        stakeToken.mint(victim, 10_000e18);
        stakeToken.mint(frontrunner, 10_000e18);
    ...
    function testLargeTradeManipulation() public {
        ...
        uint256 priceChange =
            manipulatedPrice > initialPrice ? manipulatedPrice - initialPrice : initialPrice - manipulatedPrice;
    ...
    function testFeeManipulationResistance() public {
        ...
        assertLt(attackerBalance, 50_000e18, "Attacker didn't lose money to fees");
    }
    ...
    function testDustAttacks() public {
        ...
        try cpmmMarket.buyShares(1, 1e15, 0) {
            // 0.001 tokens
