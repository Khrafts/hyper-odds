...
contract TimeDecayTest is Test {
    ...
    function testTimeMultiplierNoDecay() public {
        _initializeMarket(0);
        assertEq(market.getTimeMultiplier(), 10000, "No decay should be 1.0x (10000)");
    }
    ...
    function testTimeMultiplierEarlyDeposit() public {
        ...
        assertEq(market.getTimeMultiplier(), 11250, "Early deposit should get 1.125x (11250)");
    }
    ...
    function testTimeMultiplierMidDeposit() public {
        ...
        assertApproxEqAbs(multiplier, 10000, 50, "Mid deposit should be ~1.0x (10000)");
    }
    ...
    function testTimeMultiplierMaxDecay() public {
        ...
        // At start time
        assertEq(market.getTimeMultiplier(), 12500, "Max decay early should be 1.25x (12500)");
    ...
    function testTimeMultiplierBounds() public {
        ...
        assertTrue(market.getTimeMultiplier() <= 12500, "Multiplier should not exceed 1.25x");
    ...
    function testEffectiveStakesCalculation() public {
        ...
        assertEq(user1EffectiveStakes[1], depositAmount * 11250 / 10000, "Early deposit effective stakes incorrect");
        ...
        assertApproxEqAbs(user2EffectiveStakes[1], depositAmount, depositAmount / 100, "Mid deposit effective stakes incorrect");
    ...
    function testEffectiveStakesConsistencySimple() public {
        ...
        assertEq(
            market.totalEffectiveStakes(1),
            user1Effective[1] + user2Effective[1],
            "Total effective stakes mismatch"
        );
    }
}